...
<!--notification modal-->
<!-- Modal -->
<div class="modal fade" id="notifi_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        @csrf
        <input type="hidden" id="video_title" name="title">
         <input type="hidden" name="modal_id" id="moda">
         <label class="font-weight-bold"> Message For Nitification</label>
         <textarea col="15" rows="5" class="form-control" placeholder="Type Message Here" name="message" ></textarea>
